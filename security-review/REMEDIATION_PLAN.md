...
**Corrective checkpoint:** `KAYA-OIDC-001` and `KAYA-RDP-002` are remediated and pending independent re-verification. Six findings remain fully open. Live certificate checks 1–6 pass; check 7 reconfirms separate High finding `KAYA-RDP-001`. Preserve PR order [#58](https://github.com/antybubbs/kaya/pull/58) → [#61](https://github.com/antybubbs/kaya/pull/61) → [#60](https://github.com/antybubbs/kaya/pull/60) → [#59](https://github.com/antybubbs/kaya/pull/59).
