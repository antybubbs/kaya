...
| Man-in-the-middle presents any RDP certificate | S, I, T | None for certificate identity; `ignore-cert` is hardcoded true | Confirmed `KAYA-RDP-002`. Secure default plus CA import or fingerprint pinning required. |
