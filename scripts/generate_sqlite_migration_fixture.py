...
def generate_functional(path: Path) -> None:
    ...
    with engine.begin() as connection:
        ...
        insert(connection, "ha_backups", id=1, sync_run_id=1, node_id=1, encrypted_snapshot="synthetic-snapshot", checksum="synthetic-checksum", created_at=now)
        ...
        insert(connection, "ha_lease_snapshots", id=1, cluster_id=1, source_node_id=1, target_node_id=2, generation=7, checksum="synthetic-snapshot-checksum", encrypted_payload="synthetic-payload", created_at=now)
