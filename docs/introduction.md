...
Planned or disabled features shown in the UI, such as SSL Certificate Manager, Secret Vault, Service Catalogue, Groups, Duplication Check, System Backups, and IDP Integration, should be treated as future/planned until implemented.
