...
- KAYA-BAK-001 remains Critical and blocked. Backup-agent protocol v2 cannot be implemented or verified until the genuine production Docker-agent source repository is identified. No replacement or stub agent is included.
- KAYA-HA-001, KAYA-BG-001 and KAYA-DB-001 remain deferred High-priority hardening work.

No release-readiness decision is made by this branch. Full verification, resolution or explicit acceptance of remaining Critical risk, and human approval are still required before publication.
